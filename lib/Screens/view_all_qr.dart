...
class ViewAllQrImages extends StatefulWidget {
  const ViewAllQrImages({Key? key}) : super(key: key);

  @override
  State<ViewAllQrImages> createState() => _ViewAllQrImagesState();
}

class _ViewAllQrImagesState extends State<ViewAllQrImages> {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: const EdgeInsets.only(top: 70, left: 40, right: 40,bottom: 40),
      child: Column(
        children: [
          Expanded(
